  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'headline-xl': ['48px', { fontWeight: '700', lineHeight: '56px', letterSpacing: '-0.02em' }],
        'headline-lg': ['32px', { fontWeight: '700', lineHeight: '40px', letterSpacing: '-0.02em' }],
        ...
        'label-md': ['14px', { fontWeight: '600', lineHeight: '16px', letterSpacing: '0.05em' }],
