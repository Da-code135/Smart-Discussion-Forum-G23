{{--
    Shared statistics content — rendered on both the Admin Dashboard and the
    Platform Statistics page. Expects a $groupStats array of
    ['group' => Group, 'stats' => Statistics] items (see StatisticsUtility).
--}}
